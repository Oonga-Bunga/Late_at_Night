...
public class Rocket : MonoBehaviour
{
    ...
    [SerializeField] private GameObject _explosionPrefab = null; // Prefab del efecto de explosi�n
    ...
    void Explode()
    {
        // Crea el efecto de explosi�n en la posici�n del objeto
        ...
        {
            collider.GetComponent<AKillableEntity>().TakeHit(_blastDamage, IKillableEntity.AttackSource.Rocket);
        }
