...
public class FlashlightRechargeStation : AInteractable
{
    ...
    [SerializeField] private bool _hasFlashlight = true; // Si tiene una linterna carg�ndose o no
    ...
    /// <summary>
    /// Si tiene una linterna que no est� cargada del todo le va sumando carga con el tiempo
    /// </summary>
    ...
    /// <summary>
    /// Si la estaci�n de recarga tiene una linterna se la da al jugador, que dropea lo que tuviese equipado, 
    /// en caso contrario si el jugador tiene una linterna esta pasa a estar en la estaci�n de recarga
    /// </summary>
