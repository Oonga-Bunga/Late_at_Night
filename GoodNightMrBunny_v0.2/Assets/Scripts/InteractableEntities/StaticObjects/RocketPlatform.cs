...
public class RocketPlatform : AInteractable, IPlayerReceiver
{
    ...
    {
        // Obtén la rotación actual del punto de rotación como cuaternión
        ...
        // Asigna la nueva rotación al punto de rotación
